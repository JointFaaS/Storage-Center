...
func (x *SyncReply) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
func (x *SyncReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_sync_proto_rawDesc = []byte{
	,
...
var file_sync_proto_goTypes = []interface{}{
	(*SyncRequest)(nil), // 0: status.SyncRequest
	(*SyncReply)(nil),   // 1: status.SyncReply
}
var file_sync_proto_depIdxs = []int32{
	0, // 0: status.Sync.Sync:input_type -> status.SyncRequest
	1, // 1: status.Sync.Sync:output_type -> status.SyncReply
...
func (c *syncClient) Sync(ctx context.Context, in *SyncRequest, opts ...grpc.CallOption) (*SyncReply, error) {
	out := new(SyncReply)
	err := c.cc.Invoke(ctx, "/status.Sync/Sync", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedSyncServer) Sync(context.Context, *SyncRequest) (*SyncReply, error) {
